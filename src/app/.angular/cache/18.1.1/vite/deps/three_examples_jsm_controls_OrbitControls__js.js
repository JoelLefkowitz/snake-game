...
var OrbitControls = class extends EventDispatcher {
  constructor(object, domElement) {
    ...
    this.dispose = function() {
      ...
      document2.removeEventListener("keydown", interceptControlDown, {
        capture: true
      });
    ...
    function interceptControlDown(event) {
      if (event.key === "Control") {
        controlActive = true;
        const document2 = scope.domElement.getRootNode();
        document2.addEventListener("keyup", interceptControlUp, {
          passive: true,
          capture: true
        });
      }
    ...
    function interceptControlUp(event) {
      if (event.key === "Control") {
        controlActive = false;
        const document2 = scope.domElement.getRootNode();
        document2.removeEventListener("keyup", interceptControlUp, {
          passive: true,
          capture: true
        });
      }
